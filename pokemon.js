...
// Create a button and add a on click function
// Add sprite photo and pokemon name to the background of button
// function triggers search on pokemon api


// arrow function
const getPokemon = async (pokemon) => {
    console.log('onclick function works!', pokemon)
    try {
